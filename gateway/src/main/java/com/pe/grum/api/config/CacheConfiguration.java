...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("grum");
        ...
        config.getMapConfigs().put("com.pe.grum.api.domain.*", initializeDomainMapConfig(jHipsterProperties));
